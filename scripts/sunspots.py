...
def main():
    ...
    cant_columnas_con_datos_faltantes = df.count().iloc[1]
    cant_columnas_sin_datos_faltantes = df.dropna().count().iloc[1]
    ...
    print(f"Existen {cant_columnas_con_datos_faltantes - cant_columnas_sin_datos_faltantes} datos faltantes")

    print(f"Existen {cant_columnas_sin_datos_faltantes} entradas de datos.")
    print(f"Media del promedio del manchas solares: {media:.3f}")
